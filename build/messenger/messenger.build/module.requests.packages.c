...
static PyCodeObject *codeobj_32ff97f9665fd95fc96a4768f92a5055;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_32ff97f9665fd95fc96a4768f92a5055 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[15], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_32ff97f9665fd95fc96a4768f92a5055;
    ...
    // Frame without reuse.
    frame_32ff97f9665fd95fc96a4768f92a5055 = MAKE_MODULE_FRAME(codeobj_32ff97f9665fd95fc96a4768f92a5055, module_requests$packages);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_32ff97f9665fd95fc96a4768f92a5055);
    assert(Py_REFCNT(frame_32ff97f9665fd95fc96a4768f92a5055) == 2);
    ...
    }
    {
        ...
        frame_32ff97f9665fd95fc96a4768f92a5055->m_frame.f_lineno = 1;
    ...
    }
    {
        ...
        frame_32ff97f9665fd95fc96a4768f92a5055->m_frame.f_lineno = 7;
    ...
    }
    {
        ...
        frame_32ff97f9665fd95fc96a4768f92a5055->m_frame.f_lineno = 11;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_32ff97f9665fd95fc96a4768f92a5055);
#endif
    popFrameStack();

    assertFrameObject(frame_32ff97f9665fd95fc96a4768f92a5055);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_32ff97f9665fd95fc96a4768f92a5055, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_32ff97f9665fd95fc96a4768f92a5055->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_32ff97f9665fd95fc96a4768f92a5055, exception_lineno);
    }
